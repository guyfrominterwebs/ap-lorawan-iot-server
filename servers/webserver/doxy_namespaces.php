...
/**
	Main namespace for this system. Hosts all other namespaces 
	and backbone scripts for hosted servers.
*/
namespace Lora;
...
/**
	Namespace for hosting all content related functionality of this system.
