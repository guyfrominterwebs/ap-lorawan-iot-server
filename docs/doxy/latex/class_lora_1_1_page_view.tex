\section{Page\+View Class Reference}
\label{class_lora_1_1_page_view}\index{Page\+View@{Page\+View}}
\subsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\textbf{ \+\_\+\+\_\+construct} (string \$name=\textquotesingle{}\textquotesingle{})
\item 
\textbf{ link} (\textbf{ Page} \$page, string \$text)
\item 
\textbf{ show} (bool \$show=null)
\item 
\textbf{ id} ()
\item 
\textbf{ set\+Layout} (string \$\textbf{ layout})
\item 
\textbf{ layout} ()
\item 
\textbf{ content} ()
\item 
\textbf{ add\+Component} (string \$component\+Name)
\item 
\textbf{ components} ()
\item 
\textbf{ load} (array \$config)
...
{\em \$name} & Name of this \doxyref{Page\+View}{p.}{class_lora_1_1_page_view} \\
\hline
\end{DoxyParams}
...
Adds a new component to this \doxyref{Page\+View}{p.}{class_lora_1_1_page_view} if such exist. 
\begin{DoxyParams}{Parameters}
{\em \$component\+Name} & Name of the Page\+Componet which is wished to be added to this \doxyref{Page\+View}{p.}{class_lora_1_1_page_view}. \\
\hline
\end{DoxyParams}

\begin{DoxyCode}
82                                                          : \textcolor{keywordtype}{void} \{
83         \textcolor{keywordflow}{if} (($comp = PageComponent::Create ($componentName)) !== null) \{
84             $this->components [] = $comp;
85         \}
86     \}
\end{DoxyCode}
...
Returns an array of property field names in this class which can be set using initialization files with \doxyref{Page\+View\+::load}{p.}{class_lora_1_1_page_view_a2cb0c3fbaa3e77419479aef9716f1ce3}. 
\begin{DoxyParams}{Parameters}
...
\begin{DoxyReturn}{Returns}
Returns the name of the file containing this \doxyref{Page\+View}{p.}{class_lora_1_1_page_view}\textquotesingle{}s content and adds extension to it if one does not exist. 
\end{DoxyReturn}

\begin{DoxyCode}
74                                : \textcolor{keywordtype}{string} \{
75         \textcolor{keywordflow}{return} $this->\_content = \Lib::checkExtension ($this->\_content, 
...
\begin{center}
\leavevmode
\includegraphics[width=267pt]{class_lora_1_1_page_view_a9b80bb36f89498eac4f43bf08461240d_cgraph}
\end{center}
\end{figure}
...
\item[\textbf{ Todo}]This method should be renamed to \textquotesingle{}name\textquotesingle{}. \end{DoxyRefDesc}
\begin{DoxyReturn}{Returns}
...
\begin{center}
\leavevmode
\includegraphics[width=246pt]{class_lora_1_1_page_view_a087060b582403885d08e89ad894ecc5d_icgraph}
\end{center}
\end{figure}
...
\begin{DoxyReturn}{Returns}
Returns the name of the file containing this \doxyref{Page\+View}{p.}{class_lora_1_1_page_view}\textquotesingle{}s layout and adds extension to it if one does not exist. 
\end{DoxyReturn}

\begin{DoxyCode}
67                               : \textcolor{keywordtype}{string} \{
68         \textcolor{keywordflow}{return} $this->\_sub\_layout = \Lib::checkExtension ($this->\_sub\_layout, 
      Config::ext (\textcolor{stringliteral}{'twig'}, \textcolor{stringliteral}{'twig'}));
69     \}
\end{DoxyCode}
Here is the call graph for this function\+:\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=261pt]{class_lora_1_1_page_view_a0e9447221830f8629717836bd933a164_cgraph}
\end{center}
\end{figure}
...
\subsubsection{link()}
{\footnotesize\ttfamily link (\begin{DoxyParamCaption}\item[{\textbf{ Page}}]{\$page,  }\item[{string}]{\$text }\end{DoxyParamCaption})}

Generates an  object to this view. 
\begin{DoxyParams}{Parameters}
{\em \$page} & The page to which this view belongs to. This might be removed in the future if Page\+Views are made aware of their containing \doxyref{Page}{p.}{class_lora_1_1_page}. \\
\hline
...
\begin{DoxyCode}
33                                                     \{
34         \textcolor{keywordflow}{return} $this->link ?? $this->link = new \(\backslash\)Html\(\backslash\)Link ($text, $page->name (), [ $this->\_name => \textcolor{stringliteral}{''} ], 
      [ \textcolor{stringliteral}{'data-view-name'} => $this->\_name ]);
35     \}
\end{DoxyCode}
Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=236pt]{class_lora_1_1_page_view_a476c28dc9ec4f9be50d2e19ad74f4a06_cgraph}
\end{center}
\end{figure}
\mbox{\label{class_lora_1_1_page_view_a2cb0c3fbaa3e77419479aef9716f1ce3}} 
...
Reads preoperty values for this instance from an array. Capable of creating new \doxyref{Page\+Component}{p.}{class_lora_1_1_page_component} instances by name. 
\begin{DoxyParams}{Parameters}
...
101         \textcolor{keywordflow}{foreach} ($this->configurableFields () as $member) \{
...
110                     $this->addComponent ($comp);
111                 \}
112             \}
113         \}
114     \}
\end{DoxyCode}
\mbox{\label{class_lora_1_1_page_view_a63ba1656485acf76a0d23e8f64fdfa1d}} 
